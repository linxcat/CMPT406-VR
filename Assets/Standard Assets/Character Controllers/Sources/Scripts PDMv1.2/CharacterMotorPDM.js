...
class CharacterMotorMovementPDM {
...
var movement : CharacterMotorMovementPDM = CharacterMotorMovementPDM();

enum MovementTransferOnJumpPDM {
...
class CharacterMotorJumpingPDM {
...
var jumping : CharacterMotorJumpingPDM = CharacterMotorJumpingPDM();

class CharacterMotorMovingPlatformPDM {
	var enabled : boolean = true;
	
	var movementTransfer : MovementTransferOnJumpPDM = MovementTransferOnJumpPDM.PermaTransfer;
...
var movingPlatform : CharacterMotorMovingPlatformPDM = CharacterMotorMovingPlatformPDM();

class CharacterMotorSlidingPDM {
...
var sliding : CharacterMotorSlidingPDM = CharacterMotorSlidingPDM();
...
private function UpdateFunction () {
	...
	if (grounded && !IsGroundedTest()) {
		...
		if (movingPlatform.enabled &&
			(movingPlatform.movementTransfer == MovementTransferOnJumpPDM.InitTransfer ||
			movingPlatform.movementTransfer == MovementTransferOnJumpPDM.PermaTransfer)
		) {
...
private function ApplyInputVelocityChange (velocity : Vector3) {	
	...
	if (movingPlatform.enabled && movingPlatform.movementTransfer == MovementTransferOnJumpPDM.PermaTransfer) {
...
private function MoveWithPlatform () : boolean {
	return (
		...
		&& (grounded || movingPlatform.movementTransfer == MovementTransferOnJumpPDM.PermaLocked)
