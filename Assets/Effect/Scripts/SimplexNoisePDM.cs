...
//modified from http://webstaff.itn.liu.se/~stegu/simplexnoise/simplexnoise.pdf (public domain by Stefan Gustavson)
 
public class SimplexNoisePDM { // Simplex noise in 2D, 3D and 4D
...
static SimplexNoisePDM() { for(int i=0; i<512; i++) perm[i]=p[i & 255]; } // moved to constructor
