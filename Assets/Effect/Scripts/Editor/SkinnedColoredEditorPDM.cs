...
[CustomEditor(typeof(SKinColoredParticles))] 

public class SkinnedColoredEditorPDM : Editor {

	void Awake()
	{
		script = (SKinColoredParticles)target;
	...
	private SKinColoredParticles script;
