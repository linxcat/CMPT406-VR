...
namespace Artngame.PDM {
	...
	[CustomEditor(typeof(SKinnedPArticleEmit_StaticNonPrefab))] 

public class SkinnedEditorPDM : Editor {

	void Awake()
	{
			script = (SKinnedPArticleEmit_StaticNonPrefab)target;
		...
		private SKinnedPArticleEmit_StaticNonPrefab script;
